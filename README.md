...
10. If you are using mutiple interfaces on the same network, disable all but one (to prevent inaccurate data) then restart the program. Also, use the interface to Clear Devices and Clear Interface if you face any issues.
